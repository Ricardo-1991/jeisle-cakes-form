          ...
          <div className="container-label">
            <label>
              ...
              >
                ...
                <option value="1x">
                  1x de{' '}
                  {formatPrice(states.installmentsPrice.installments['1x'])} com
                  juros de 2,9 % a.m total:{' '}
                  {formatPrice(
                ...
                <option value="2x">
                  2x de{' '}
                  {formatPrice(states.installmentsPrice.installments['2x'])} com
                  juros de 4,59 % a.m. total:{' '}
                  {formatPrice(
                ...
                <option value="3x">
                  3x de{' '}
                  {formatPrice(states.installmentsPrice.installments['3x'])} com
                  juros de 5,23 % a.m. total:{' '}
                  {formatPrice(
                ...
                <option value="4x">
                  4x de{' '}
                  {formatPrice(states.installmentsPrice.installments['4x'])} com
                  juros de 5,87 % a.m. total:{' '}
                  {formatPrice(
                ...
                <option value="5x">
                  5x de{' '}
                  {formatPrice(states.installmentsPrice.installments['5x'])} com
                  juros de 6,51 % a.m. total:{' '}
                  {formatPrice(
                ...
                <option value="6x">
                  6x de{' '}
                  {formatPrice(states.installmentsPrice.installments['6x'])} com
                  juros de 7,15 % a.m. total:{' '}
                  {formatPrice(
